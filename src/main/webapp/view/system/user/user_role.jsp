	...
	<div class="panel panel-default form-search">
		<div class="panel-body">
			<div class="conditions_team">
				<input type="text" name="" value="${user.userName}" class="form-control" placeholder="userId" readonly="readonly">
				<input type="text" name="" value="${user.phone}" class="form-control" placeholder="roleId" readonly="readonly">
			</div>
		</div>
	</div>
	<!-- 列表：查询条件组装  end -->
		 ...
		 success:function(data){
			 ...
			 if(null!=data.data){
				 ...
				 $.each(data.data,function(index,obj){
					...
					//回显已选择的角色ID
					 if(roleId==obj.id && obj.hasvalid != 0 && obj.id!=1){
					...
					else if(roleId!=obj.id && obj.hasvalid != 0&& obj.id!=1)
					{
						roleDiv+="<div class='radio'>"
						 	 +"	<label>"
