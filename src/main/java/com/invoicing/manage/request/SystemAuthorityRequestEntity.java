...
public class SystemAuthorityRequestEntity extends BaseRequestEntity {
     ...
     * 子菜单列表
     */
    private List<SystemAuthorityRequestEntity> sonAuthMenuList;
	...
	public List<SystemAuthorityRequestEntity> getSonAuthMenuList() {
		return sonAuthMenuList;
	}
	public void setSonAuthMenuList(List<SystemAuthorityRequestEntity> sonAuthMenuList) {
